package com.sanelee.springbootneo4jschool.core;
...
public class CoreProcessor {
    ...
    public  String queryAbstract(String querySentence) {
        ...
        for (Term term : terms) {
            ...
            }else if (termStr.contains("ntu")) { //ntu 学校名
                abstractQuery += "ntu ";
                abstractMap.put("ntu", word);
            }else if (termStr.contains("pr")) { //pr 专业名
                abstractQuery += "pr ";
    ...
    public Map<Double,String> loadQuestionTemplates() {
        Map<Double, String> questionsPattern = new HashMap<>(8);
